...
import LeavedStudents from "./LeavedStudents";
      ...
      <TabContext value={value}>
        <Box>
          <TabList onChange={handleChange} aria-label="lab API tabs example">
            ...
            <Tab label="Đang theo học" value={1} />
            <Tab label="Đã tốt nghiệp" value={2} />
            <Tab label="Đã hoàn thành chương trình" value={3} />
            <Tab label="Bỏ học" value={4} />
          </TabList>
        </Box>
        <Box>
