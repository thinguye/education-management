...
const Certificate = () => {
    ...
    },
    {
      ...
      options: {
        ...
        customBodyRender: (value) =>
          value.length > 0 && value[0].code == "IELTS 6.0" ? "Đạt" : "Chưa đạt",
      },
    },
    {
      name: "conditions",
      ...
      options: {
        ...
        sort: false,
        customBodyRender: (value) =>
          (value.length == 1 && value[0].code == "MET 100") ||
          (value.length == 2 && value[1].code == "MET 100")
            ? "Đạt"
            : "Chưa đạt",
      },
    },
  ...
  useEffect(() => {
    studentApi.getIncompleteStudents().then((res) => {
      setData(res);
