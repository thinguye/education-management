      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            console.log(request);
            var res = await authApi.signUp(request);
          ...
          <form noValidate onSubmit={handleSubmit} {...others}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  {touched.firstname && errors.firstname && (
                    <FormHelperText
                      error
                      id="standard-weight-helper-fname-text-register"
                    >
                      {errors.firstname}
                    </FormHelperText>
                  )}
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  {touched.lastname && errors.lastname && (
                    <FormHelperText
                      error
                      id="standard-weight-helper-lname-text-register"
                    >
                      {errors.lastname}
                    </FormHelperText>
                  )}
            ...
            >
              ...
              {touched.email && errors.email && (
                <FormHelperText
                  error
                  id="standard-weight-helper-email-text-register"
                >
                  {errors.email}
                </FormHelperText>
              )}
